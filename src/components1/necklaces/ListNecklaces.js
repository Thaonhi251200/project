...
export default function ListNecklaces() {
    const arr = [img81, img91, img101, img121, img131,
        img141, img151, img161, img171, img181, img191, img201]
    const arr1 = [ img82, img92, img102, img122,
            ...
            <Container>
                <Row>
                    {data.slice(8,12 ).map((item, index) => {
                        return <Necklaces item={item} key={index} img={arr[index]} img1={arr1[index]} />
                    })}
                </Row>  
            </Container>
