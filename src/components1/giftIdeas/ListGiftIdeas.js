...
export default function ListGiftIdeas() {
    const arr = [img171, img181, img191, img201]
    const arr1 = [
    ...
    return (
        <div>
            <Container>
                <Row>
                    {data.slice(17, 20).map((item, index) => {
                        return <GiftIdeas item={item} key={index} img={arr[index]} img1={arr1[index]} />
                    })}
                </Row>  
            </Container>
