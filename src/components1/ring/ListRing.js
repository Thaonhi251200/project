...
export default function ListRing() {
    const arr = [img11, img21, img31, img111,img41, img51, img61, img71, img81, img91, img101,  img121, img131,
        img141, img151, img161, img171, img181, img191, img201]
    const arr1 = [img12, img22, img32,img112, img42
        , img52, img62, img72, img82, img92, img102,  img122,
            ...
            <Container>
                <Row>
                    {data.slice(0, 4).map((item, index) => {
                        return <Ring item={item} key={index} img={arr[index]} img1={arr1[index]} />
                    })}
                </Row>  
            </Container>
